...
class Assignments(models.Model):
    ...
    invoicefrom = models.IntegerField(blank=True, null=True)
    suspended = models.IntegerField()
    suspended_to = models.IntegerField()
...
class Customers(models.Model):
    ...
    lease_antena = models.IntegerField()
    lease_iptv = models.IntegerField()
    is_executed = models.IntegerField(blank=True, null=True)
    block_state = models.IntegerField(blank=True, null=True)
...
class Ftpquotatallies(models.Model):
    name = models.CharField(max_length=30, db_collation='latin1_swedish_ci')
    quota_type = models.CharField(max_length=5, db_collation='latin1_swedish_ci')
...
class Netdevices(models.Model):
    ...
    wlan_mac = models.CharField(max_length=32, blank=True, null=True)
    wlan_azimuth = models.DecimalField(max_digits=9, decimal_places=2, blank=True, null=True)
    wlan_altitude = models.DecimalField(max_digits=9, decimal_places=2, blank=True, null=True)
    wlan_rsrange = models.IntegerField(blank=True, null=True)
    wlan_width = models.DecimalField(max_digits=9, decimal_places=2, blank=True, null=True)
    wlan_mode = models.IntegerField(blank=True, null=True)
...
class Routers(models.Model):
    ...
    devtype = models.ForeignKey('Routerstype', models.DO_NOTHING)
    dev_info = models.TextField()
    backup_result = models.CharField(max_length=10)
...
class RoutersBackups(models.Model):
    date = models.DateTimeField()
    file_name = models.CharField(max_length=500)
    type = models.CharField(max_length=15)
    file_ext = models.CharField(max_length=15, blank=True, null=True)
    time_backup = models.DecimalField(max_digits=6, decimal_places=1)
    dev_id = models.ForeignKey(Routers, models.DO_NOTHING)
...
class Sysvars(models.Model):
    varname = models.CharField(primary_key=True, max_length=250)
    varsection = models.CharField(max_length=100, blank=True, null=True)
...
class Wlanchannels(models.Model):
    channel_width = models.CharField(max_length=255)
    width = models.IntegerField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'wlanchannels'
